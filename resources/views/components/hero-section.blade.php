...
@php
    $backgroundClasses = match($background) {
        ...
        'gray' => 'bg-gradient-to-br from-gray-600 via-gray-700 to-gray-800',
        default => 'bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800'
    };
...
<div class="relative {{ $backgroundClasses }} text-white overflow-hidden">
    @if($showPattern)
        <!-- Background Pattern -->
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div class="text-center">
            ...
            <h1 class="text-4xl md:text-6xl font-bold mb-6 text-white" style="color: #ffffff !important; text-shadow: 2px 2px 4px rgba(0,0,0,0.3);">
                {{ $title }}
            </h1>
            <p class="text-xl text-white max-w-3xl mx-auto leading-relaxed" style="color: #ffffff !important; text-shadow: 1px 1px 2px rgba(0,0,0,0.3);">
                {{ $subtitle }}
            </p>
        </div>
    </div>
